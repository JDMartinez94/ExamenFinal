...
insert into telefono(telefono,telDescrip) values('2132-7536','Oficina
Principal');
insert into departamento(nombreDepto,cantEmpleados, codTels) values
('Escuela de Computación',25,1);
insert into usuarios
values(1,'perezila','123','Admin'),(2,'goku33','123','Auditor'),(3,'Shiri
gami','123','Simple Usuario');
insert into empleado(nombres, apellidos, idDepartamento, salario, edad,
idUsuario)
